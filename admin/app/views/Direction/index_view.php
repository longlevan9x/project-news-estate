            ...
            <div class="panel panel-info">
                ...
                <?php echo (!empty($editOk) || !empty($deleteOk)) ? "<p class='text-center bg-success' style='padding: 5px;border-radius: 5px;'>" . $editOk . $deleteOk . "</p>" : ''; ?>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                        <?php $i = 1; ?>
                        <?php foreach ($direction as $k => $val): ?>
                            <tr>
                                <td style="text-align:center;"><?php echo $i; ?></td>
                                <td><?php echo $val['name_direction']; ?></td>
                                <td>
                                    <a href="<?php echo site_url('direction/index/editdirection/'.$val['id']); ?>" class="btn btn-lager btn-warning">
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Bạn có muốn xóa <?php echo $title; ?> <?php echo $val['name_direction']; ?>?</h4>
                                                 </div>
                                                <div class="modal-footer">
                                                    <a href="<?php echo site_url('direction/deleteDirection/'.$val['id']); ?>" class="btn btn-lager btn-danger" >
        ...
        <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
            <div class="panel panel-primary" style="width: 450px">
                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo site_url('direction/addDirection'); ?>" method="post" accept-charset="utf-8">
