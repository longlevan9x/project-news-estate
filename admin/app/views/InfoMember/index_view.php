                    ...
                    <table class="table table-striped table-infoadmin" >
                        ...
                        <?php foreach ($admin as $k => $val): ?>
                            <tr>
                                ...
                                <td>
                                    <img src="<?php echo PATH_IMG_MEMBER.$val['avatar']; ?>" alt="" style="width: 90px">
                                </td>
                                <td style="text-align:center;">
                                    <?php if ($val['is_active'] == 0): ?>
                                        Ko kích hoạt
                                    <?php elseif($val['is_active'] == 1): ?>
                                        kích hoạt
                                    <?php endif ?>
                                </td>
                                <td>
                                    <a href="<?php echo site_url('infomember/index/view-info/'.$val['id']); ?>" class="btn btn-xs btn-info">
                                        <span class="glyphicon glyphicon-eye-open">Xem.</span>
                                    </a>
                                    <a href="<?php echo site_url('infomember/index/edit-info/'.$val['id']); ?>" class="btn btn-xs btn-warning">
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="<?php echo site_url('infomember/deleteInfo/'.$val['id']); ?>" class="btn btn-lager btn-danger" >
