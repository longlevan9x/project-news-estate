            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo site_url('infoadmin/index/action-edit-info/'.$id); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        ...
                        <br>
                        <input class="form-control" placeholder="Ngày sinh" name="txtBirthday" id="txtBirthday" type="date" title="Ngày sinh phải trước năm 2000" value="<?php echo $birthday; ?>">
                        <br>
                        <div class="form-group">
                            <select name="txtRole" class="form-control">
                                <option value="-2">---Chọn quyền---</option>
                                <option value="1" <?php echo (!empty($role) && $role == 1) ? "selected='selected'" : ''; ?>>Admin bậc 1</option>
                                <option value="2" <?php echo (!empty($role) && $role == 2) ? "selected='selected'" : ''; ?>>Admin bậc 2</option>
                                <option value="3" <?php echo (!empty($role) && $role == 3) ? "selected='selected'" : ''; ?>>Admin bậc 3</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <select name="txtStatus" id="txtStatus" class="form-control">
                                <option value="-2">---Chọn trạng thái---</option>
                                <option value="1" <?php echo (!empty($status) && $status == 0) ? "selected='selected'" : ''; ?>>Không kích hoạt</option>
                                <option value="2" <?php echo (!empty($status) && $status == 1) ? "selected='selected'" : ''; ?>>Kích hoạt</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <img src="../../../../uploads/imgAdmin/<?php echo $avatar; ?>" alt=""  style="width: 100px;">
                        </div>
